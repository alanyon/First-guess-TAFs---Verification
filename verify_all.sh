...
export DATA_DIR=/data/users/alanyon/tafs/improver/verification/20230805-20241004_ml_2
export STATS_DIR=${DATA_DIR}/ver_stats_all
...
export TAF_TYPES="FirstGuessAll ManualAll"
export COMBS="mafg"
