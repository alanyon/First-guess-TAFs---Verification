...
# Directory holding rolling.py and the pkg_resources compat shim (compat/)
CODE_DIR=/home/users/andre.lanyon/first_guess_tafs/First-guess-TAFs---Verification/standard_verification
...
export CYCLE_DATE=20260925
# VerPy plus the local pkg_resources compat shim (compat/) so VerPy imports
# under scitools os48+ where setuptools no longer ships pkg_resources.
export PYTHONPATH=~clare.bysouth/VerPy/stable:${CODE_DIR}/compat
...
module unload scitools/production-os48-1
