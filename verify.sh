...
export DATA_DIR=/data/users/andre.lanyon/tafs/verification/20230805-20250304_test
...
export TAF_TYPES="ImproverNoObsOpt ImproverNoObsPes ImproverObsOpt ImproverObsPes Manual"
export COMBS="i1ma i2ma i3ma i4ma i1i2 i1i3 i1i4 i2i3 i2i4 i3i4"
export VERIF_START=20230804
export VERIF_END=20250304
